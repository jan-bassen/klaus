---
name: obsidian-bases-functions
description: Use advanced functions in Obsidian Bases (.base files). This is an extension of the obsidian-bases skill containing an overview of available functions.
---
