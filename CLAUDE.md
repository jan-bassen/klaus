...
10. **Assemble context** — extract `?params` from prompt template + user message, run all context variables in parallel (with params), trim to char budget
