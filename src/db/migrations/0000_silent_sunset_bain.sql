...
CREATE TABLE "llm_budgets" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "uq_llm_budgets_chat" UNIQUE("chat_id")
);
--> statement-breakpoint
...
CREATE INDEX "idx_agent_invocations_message" ON "agent_invocations" USING btree ("message_id");--> statement-breakpoint
