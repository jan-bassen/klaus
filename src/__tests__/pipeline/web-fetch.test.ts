...
describe("fetchWebContent", () => {
	...
	test("fetches and parses HTML content", async () => {
		...
		expect(mockDefuddle).toHaveBeenCalledTimes(1);
	});
	...
	test("returns Error when defuddle throws", async () => {
		...
		mockDefuddle.mockImplementationOnce(async () => {
